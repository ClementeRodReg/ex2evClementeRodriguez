...
public class FragmentContenido extends Fragment {
     ...
     * @return A new instance of fragment FragmentContenido.
     */
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstance) {
        ...
        atras=view.findViewById(R.id.botonAtras);
        //Al pulsar el boton llama a un metodo de Main activity para cambiar de fragment
        atras.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ((MainActivity)getActivity()).llamarMapa();
            }
        });
    }
}